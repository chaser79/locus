...
class LocusChannels {
  ...
  static const MethodChannel headlessValidation = MethodChannel(
    'locus/headless_validation',
  );
  static const MethodChannel headlessHeaders = MethodChannel(
    'locus/headless_headers',
  );
}
